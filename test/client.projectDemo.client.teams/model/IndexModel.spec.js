...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestCenter.IndexModel();
  });
  ...
  describe('IndexModel', function() {
    it('should create an instance of IndexModel', function() {
      // uncomment below and update the code to test IndexModel
      //var instance = new TestCenter.IndexModel();
      //expect(instance).to.be.a(TestCenter.IndexModel);
    });
    ...
    it('should have the property esIndexName (base name: "esIndexName")', function() {
      // uncomment below and update the code to test the property esIndexName
      //var instance = new TestCenter.IndexModel();
      //expect(instance).to.be();
    });
    ...
    it('should have the property autoAppendFromCollection (base name: "autoAppendFromCollection")', function() {
      // uncomment below and update the code to test the property autoAppendFromCollection
      //var instance = new TestCenter.IndexModel();
      //expect(instance).to.be();
    });
